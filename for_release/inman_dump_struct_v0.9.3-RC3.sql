...
CREATE FUNCTION delete_user_freeradius() RETURNS trigger
    LANGUAGE plpythonu
    AS $$
...
CREATE FUNCTION list_user_freeradius() RETURNS trigger
    LANGUAGE plpythonu
    AS $$
...
CREATE FUNCTION update_user_freeradius() RETURNS trigger
    LANGUAGE plpythonu
    AS $$
